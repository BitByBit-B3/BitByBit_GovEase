        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20">
          <div className="text-center">
            ...
            <div className="animate-fade-in-up stagger-1">
              <p className="mt-8 max-w-3xl mx-auto text-xl text-white/90 leading-relaxed font-medium">
                Experience the future of government services. Book appointments instantly, 
                manage documents digitally, and access all services from one unified platform.
              </p>
            </div>
            <div className="mt-12 flex flex-col sm:flex-row gap-6 justify-center animate-fade-in-up stagger-2">
              <Link href="/auth?mode=register" className="btn-primary text-lg px-10 py-5 font-semibold">
                Start Your Journey
                <CalendarDaysIcon className="ml-3 h-6 w-6" />
              </Link>
              <Link href="/services" className="btn-secondary text-lg px-10 py-5 font-semibold bg-white/10 backdrop-blur-sm border-white/20 text-white hover:bg-white hover:text-gray-900">
                Explore Services
